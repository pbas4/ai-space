...
test('validates shared planner, reviewer, and model contracts', () => {
  ...
  assert.equal(validateApprovalReceipt({ planId: 'plan-1', planHash: 'a'.repeat(64), editSetHash: 'b'.repeat(64), approvedBy: 'Pol', approvedAt: '2026-08-26T10:00:00.000Z' }, { requireEditSetHash: true }).valid, true);
});
